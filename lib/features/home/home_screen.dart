        ...
        child: Container(
          ...
          child: ClipRRect(
            ...
            child: Stack(
              ...
              children: [
                Image.asset(
                  'assets/images/goride_hero.png',
                  fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(color: Go212Colors.neutral200),
                ),
      ...
      child: Container(
        ...
        child: Row(children: [
          ClipRRect(
            ...
            child: Image.asset(
              'assets/images/gowash_hero.png',
              width: 52,
              height: 52,
              fit: BoxFit.cover,
              errorBuilder: (_, __, ___) => Container(color: Go212Colors.neutral100, width: 52, height: 52),
            ),
          ),
          ...
          child: ClipRRect(
            ...
            child: Stack(fit: StackFit.expand, children: [
              Image.asset(
                i.img,
                fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => Container(color: i.accent.withOpacity(0.1)),
              ),
            ...
            child: Stack(
              ...
              children: [
                ...
                Image.asset(
                  d.img,
                  fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(color: d.color.withOpacity(0.1)),
                ),
