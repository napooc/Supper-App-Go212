        ...
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _FeatureCard(
                          ...
                          'Scooter électrique',
                          'Flow 2026 — puissant et silencieux',
                          Go212Colors.primary600),
                      _FeatureCard(
                          Icons.battery_charging_full_rounded,
                          'Swap batterie',
                          'Échangez en 10 secondes',
                          const Color(0xFF6366F1)),
                      _FeatureCard(
                          Icons.all_inclusive_rounded,
                          'Autonomie illimitée',
                          'Réseau GoSwap en ville',
                      ...
                      _FeatureCard(
                          ...
                          'Casque fourni',
                          '2 casques avec chaque location',
                      ...
                      Row(children: [
                        Expanded(
                            child: _PricingCard('2h', '60', 'Minimum', false)),
                        const SizedBox(width: 10),
                        Expanded(
                            child: _PricingCard(
                                '4h', '100', 'Demi-journée', true)),
                        const SizedBox(width: 10),
                        Expanded(
                            child:
                                _PricingCard('24h', '200', 'Journée', false)),
                      ]),
                      const SizedBox(height: 28),
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                            ...
                            children: [
                              _GalleryImg('assets/images/goride.png'),
                              const SizedBox(width: 12),
                              _GalleryImg('assets/images/gobike.png'),
                              const SizedBox(width: 12),
                              _GalleryImg('assets/images/gowash.png'),
                            ]),
                      ),
                      const SizedBox(height: 28),
                      ...
                      Text('Comment ça marche',
                          style: Theme.of(context)
                              ...
                              ?.copyWith(
                                  ...
                                  color: Go212Colors.neutral800)),
                      const SizedBox(height: 16),
                      _Step(1, 'Réservez en ligne',
                          'Choisissez durée et mode de retrait'),
                      _Step(2, 'Livraison ou retrait',
                          'En 15 min chez vous ou en agence'),
                      _Step(
                          3, 'Roulez', 'Profitez de Casablanca en électrique'),
                      _Step(4, 'Retour',
                          'Retournez le scooter ou swappez la batterie'),
                      const SizedBox(height: 28),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.white, boxShadow: Go212Shadows.bottomNav),
              child: Row(children: [
                Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisSize: MainAxisSize.min,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: pop ? Go212Colors.primary500 : Go212Colors.neutral200,
            width: pop ? 2 : 1),
        boxShadow: pop
            ? [
                BoxShadow(
                    color: Go212Colors.primary600.withOpacity(0.15),
                    blurRadius: 16,
      ...
      child: Column(children: [
        ...
        Text(label,
            style: Theme.of(context)
                .textTheme
                .labelSmall
                ?.copyWith(color: Go212Colors.neutral400)),
        if (pop) ...[
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text(t,
              style: Theme.of(context).textTheme.titleSmall?.copyWith(
                  fontWeight: FontWeight.w600, color: Go212Colors.neutral800)),
          Text(s,
              style: Theme.of(context)
                  .textTheme
                  .bodySmall
    ...
    return Column(children: [
      Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10)),
          child: Icon(icon, color: Go212Colors.primary400, size: 20)),
      const SizedBox(height: 6),
      Text(label,
          style: TextStyle(
