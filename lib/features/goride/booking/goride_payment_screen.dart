...
class _GoRidePaymentScreenState extends State<GoRidePaymentScreen>
  ...
  Widget _buildMethodCard(_PayMethod method) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? method.color.withOpacity(0.06) : Colors.white,
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 12,
                  color: method.color.withOpacity(0.9),
                  height: 1.4),
            ),
          ),
        ],
  ...
  Widget _buildCmiForm(_PayMethod method) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: method.color.withOpacity(0.04),
